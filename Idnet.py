...
class Idnet(nn.Module):
    def __init__(self):
        ...
        self.conv_layer1 = nn.Conv2d(2048, 1024, kernel_size=3, stride=2, padding=1)
        self.conv_layer2 = nn.Conv2d(1024, 1024, kernel_size=3, stride=2, padding=1)
        self.conv_layer3 = nn.Conv2d(1024, 512, kernel_size=3, stride=2, padding=1)
        self.conv_layer4 = nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=1)
